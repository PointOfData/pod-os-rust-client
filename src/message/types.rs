...
impl Message {
    ...
    pub fn intent(&self) -> &Intent {
        &self.envelope.intent
    }
    pub fn client_name(&self) -> &str {
        &self.envelope.client_name
    }
    ...
    pub fn tags(&self) -> Vec<&TagOutput> {
        self.event
            .as_ref()
            .map_or_else(Vec::new, |e| e.tags.iter().collect())
    }
